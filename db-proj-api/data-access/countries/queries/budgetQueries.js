...
WITH tmpTbl AS
(
    SELECT Country_Code, Country_Name, Budget, Release_Date
...
SELECT Country_Code, Country_Name, Release_Date, SUM(Budget) Budget
FROM tmpTbl 
GROUP BY Country_Code, Country_Name, Release_Date
HAVING  UPPER(Country_Code) LIKE UPPER(:countryCode)
